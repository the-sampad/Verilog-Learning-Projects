...
HD_PWD='F:/Vivado designs/Decoder2X4_Sampad/Decoder2X4_Sampad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_2x4.tcl
