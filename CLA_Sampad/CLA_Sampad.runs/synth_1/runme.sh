...
HD_PWD='F:/Vivado designs/CLA_Sampad/CLA_Sampad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_4bit.tcl
