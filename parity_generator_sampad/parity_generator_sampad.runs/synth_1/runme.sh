...
HD_PWD='F:/Vivado designs/parity_generator_sampad/parity_generator_sampad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parity_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parity_generator.tcl
