...
HD_PWD='F:/Vivado designs/encoder_4x2/encoder_4x2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_4x2.tcl
