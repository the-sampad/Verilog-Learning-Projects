...
HD_PWD='F:/Vivado designs/largest/largest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log largest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source largest.tcl
