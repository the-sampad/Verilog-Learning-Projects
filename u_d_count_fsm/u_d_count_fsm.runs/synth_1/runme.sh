...
HD_PWD='F:/Vivado designs/u_d_count_fsm/u_d_count_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_d_count_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_d_count_moore.tcl
