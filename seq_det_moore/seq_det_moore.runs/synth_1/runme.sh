...
HD_PWD='F:/Vivado designs/seq_det_moore/seq_det_moore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_det_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_det_moore.tcl
