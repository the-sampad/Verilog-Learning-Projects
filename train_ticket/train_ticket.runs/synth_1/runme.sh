...
HD_PWD='F:/Vivado designs/train_ticket/train_ticket.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log train_ticket.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source train_ticket.tcl
