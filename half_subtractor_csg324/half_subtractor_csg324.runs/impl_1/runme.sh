...
HD_PWD='F:/Vivado designs/half_subtractor_csg324/half_subtractor_csg324.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_subtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_subtractor.tcl -notrace
