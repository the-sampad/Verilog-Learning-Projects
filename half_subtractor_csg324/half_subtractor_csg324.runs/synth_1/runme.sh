...
HD_PWD='F:/Vivado designs/half_subtractor_csg324/half_subtractor_csg324.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_subtractor.tcl
