...
HD_PWD='F:/Vivado designs/up_down_counter/up_down_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_d_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_d_count.tcl
