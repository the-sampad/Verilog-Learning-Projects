...
HD_PWD='F:/Vivado designs/up_down_counter/up_down_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log u_d_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source u_d_count.tcl -notrace
