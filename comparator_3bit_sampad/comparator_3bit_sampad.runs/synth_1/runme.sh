...
HD_PWD='F:/Vivado designs/comparator_3bit_sampad/comparator_3bit_sampad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_3bit.tcl
