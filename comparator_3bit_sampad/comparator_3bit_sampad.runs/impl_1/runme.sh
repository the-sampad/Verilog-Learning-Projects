...
HD_PWD='F:/Vivado designs/comparator_3bit_sampad/comparator_3bit_sampad.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_3bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_3bit.tcl -notrace
